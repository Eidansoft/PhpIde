 ...
 * Define paths
 */
define('CONF_FILE', dirname(dirname(__FILE__)).'/'.'opauth.phpide.conf.php');
define('OPAUTH_LIB_DIR', dirname(dirname(__FILE__)).'/Opauth/');
...
//$config['request_uri'] = $config['path'] . 'google';
